...
from chat_rag.components.observability import events, telemetry as T
from chat_rag.components.provenance import capture as capture_pipeline_snapshot
from chat_rag.components.viewer import analysis as viewer_analysis
...
def _run(services, job, kb, pipeline) -> dict:
    ...
    if deep_report is not None:
        from chat_rag.components.chunker.deep_analysis import product_summary
