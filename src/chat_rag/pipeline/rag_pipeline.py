...
from chat_rag.config.settings import DEFAULT_RETRIEVAL_PROFILE, RETRIEVAL_PROFILES
from chat_rag.components.llm import (
    BaseLLM, AzureOpenAILLM, OllamaLLM, UnavailableLLM, OpenAICompatibleLLM, FallbackLLM,
)
from chat_rag.components.embedding import (
    BaseEmbedding, SentenceTransformerEmbedding, OpenAICompatibleEmbedding,
)
from chat_rag.components.context import assemble_context
from chat_rag.config import paths as data_paths
from chat_rag.components.vectordb import BaseVectorDB, PgVectorStore
from chat_rag.components.chunker import BaseChunker, create_chunker
...
from chat_rag.components.parsers import ParserFactory
...
from chat_rag.components.ingest.limits import checkpoint
from chat_rag.components.observability import telemetry as T
from chat_rag.components.query.limits import LimitedAnswerModel
from chat_rag.utils.logger import get_logger, RAGLogger
...
class RAGPipeline:
    ...
    def ingest_document(
        ...
        try:
            ...
            if deep_analysis:
                ...
                from chat_rag.components.chunker.deep_analysis import (
                    build_configuration,
                    deep_config,
                    limited_providers,
                )
    ...
    def model_chain(self) -> Dict[str, Any]:
        ...
        from chat_rag.components.chunker.deep_analysis import build_configuration, deep_config
        from chat_rag.components.chunker.structural_chunker import (
            HARD_MAX_TOKENS, MIN_TOKENS, SOFT_MAX_TOKENS, TARGET_TOKENS,
        )
