...
from chat_rag.core.exceptions import EmbeddingException, RetrieverException
...
def _identity(embedding_model: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        pass
    from chat_rag.components.embedding.openai_compatible_embedding import embedding_fingerprint
