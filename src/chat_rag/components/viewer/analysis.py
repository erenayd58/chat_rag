...
from chat_rag.utils import get_logger
...
def _counter():
    ...
    from chat_rag.components.chunker.structural_chunker import TOKEN_ENCODING
...
def _deterministic_deep(key: str) -> Any:
    ...
    from chat_rag.components.chunker.deep_analysis import deep_config
