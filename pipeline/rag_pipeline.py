...
class RAGPipeline:
    ...
    GROUNDED_SYSTEM_PROMPT = (
        ...
        "4. Kaynaklar soruyu cevaplamaya yetmiyorsa cevabına tam olarak şu cümleyle başla: "
        "'Kaynaklarda bu soru için yeterli bilgi yok.' ve ardından kaynaklarda bulunan "
        "en yakın bilgiyi kısaca belirt.\n"
        "5. Sorunun dilinde, doğal ve öz bir dille cevap ver; Türkçe soruya Türkçe cevap ver.\n"
        "6. Cevabı düz metin olarak yaz; JSON, başlık veya kaynak listesi ekleme."
    )
